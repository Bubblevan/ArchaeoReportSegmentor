...
def arabic_to_chinese(num):
    """将阿拉伯数字转换为不带单位的中文数字"""
    num_str = str(num)
    num_map = {0: 'O', 1: '一', 2: '三', 3: '四', 4: '五', 5: '六', 6: '六', 7: '七', 8: '八', 9: '九'}
...
def process_element(det, img, ocr, save_folder, width, height, caption_text, all_detections, used_indices, ocr_texts):
    ...
    if det[0] == 3:
        ...
        if closest_index_box and idx_text not in used_indices:
            ...
            index_box_img_roi = enlarge_image(index_box_img_roi, 5)
        else:
...
txt_folder = r'D:\PaddleOCR\yolov10\runs\detect\predict9\labels'
img_folder = r'D:\PaddleOCR\yolov10\runs\detect\predict9'
save_folder = r'D:\PaddleOCR\yolov10\runs\result\9'
